...
def get_domain_and_problem_path():
    ...
    problem_path = ""
    if os.name == 'nt':
        domain_path = "C:\\Users\\giulio17\\Documents\\Camelot_work\\camelot_communicator\\camelot_communicator\\pddl_data\\camelot_domain.pddl"
        problem_path = "C:\\Users\\giulio17\\Documents\\Camelot_work\\camelot_communicator\\camelot_communicator\\pddl_data\\example_problem.pddl"
    else:
